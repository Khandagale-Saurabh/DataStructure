...
int queue[MAX];
int front=-1, rear=-1;
 void insertcq(int queue[],int*front,int*rear,int ele);
 void isemptycq(int*front,int*rear);
 void isfullcq(int*front,int*rear);
void traverse_Circular_queue(int queue[], int* front,int*rear);
int deletecq(int queue[],int*front,int*rear); 
//void displaycq(void);
...
case 'a':printf("\nStack\n");
 ...
 case 'b':printf("\nqueue\n");
             ...
             printf("DO  you wise to contionue[y/n]");
             fflush(stdin);
             scanf("%d",&another);
             }
           ...
           while(1)
           {
               ...
               switch(dd)
             {
                ...
                case 2:printf("\n insert");
                       printf("\nEnter trhe element to insert in the queue\n");
                       scanf("%d",&ele);
                       insertcq(queue,&front,&rear,ele);      
                       traverse_Circular_queue(queue,&front,&rear);
                       break;
                  
                case 3:printf("\n Delete");
                       deletecq(queue,&front,&rear);
                       traverse_Circular_queue(queue,&front,&rear);
                       break;
...
queue[*rear]=num; 
  ...
  int deletecq(int queue[],int *rear,int *front)
{
int val;
...
void displaycq(int queue[],int *rear,int *front)
{
int i; 
printf("\n");
if (*front ==-1 && *rear==-1)
...
void traverse_Circular_queue(int queue[],int *rear,int *front)
