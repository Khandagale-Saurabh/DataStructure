...
int main()
{
int option, val; struct node *ptr; 
create_tree(tree);
// clrscr();
do
{
...
{
case 1:
printf("\n Enter the value of the new node : "); scanf("%d", &val);
...
parentptr=nodeptr; if(val<nodeptr->data)
...
cur = cur->left; while(suc->left!=NULL)
{
...
else
{
    ...
    leftheight = Height(tree->left); rightheight = Height(tree->right); if(leftheight > rightheight)
   return (leftheight + 1);
